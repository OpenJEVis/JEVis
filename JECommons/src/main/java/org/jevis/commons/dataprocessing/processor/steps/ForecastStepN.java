...
import static org.jevis.commons.dataprocessing.processor.GapsAndLimitsN.getNote;

public class ForecastStepN implements ProcessStepN {
    @Override
    ...
    private Double getSpecificValue(List<JEVisSample> sampleCache, List<CleanIntervalN> intervals, JsonGapFillingConfig c, DateTime lastDate) throws JEVisException {
