 ...
 * @author gschutz
 */
public class ResourceManagerN {

    private static final Logger logger = LogManager.getLogger(ResourceManagerN.class);
    public List<CleanIntervalN> intervals = new ArrayList<>();
    ...
    private List<CleanIntervalN> rawIntervals = new ArrayList<>();
    private Boolean isClean = true;

    public List<CleanIntervalN> getIntervals() {
        return intervals;
    }

    public void setIntervals(List<CleanIntervalN> intervals) {
    ...
    public List<CleanIntervalN> getRawIntervals() {
            ...
            for (PeriodRule rawPeriodRule : rawPeriodAlignment) {
                ...
                if (!currentRawDataPeriod.equals(Period.ZERO) && currentRawDataPeriod.getMonths() == 0 && currentRawDataPeriod.getYears() == 0
                    ...
                    while (currentDate.isBefore(maxEndDate) && (nextRawDataPeriodTS == null || currentDate.isBefore(nextRawDataPeriodTS))) {
                        ...
                        CleanIntervalN currentInterval = new CleanIntervalN(interval, currentDate);
                    ...
                    try {
                        ...
                        while (currentTs.isBefore(lastTs) && (nextRawDataPeriodTS == null || currentTs.isBefore(nextRawDataPeriodTS))) {
                            ...
                            CleanIntervalN CleanIntervalN = new CleanIntervalN(interval, currentTs);
                            rawIntervals.add(CleanIntervalN);
    ...
    public void setRawIntervals(List<CleanIntervalN> rawIntervals) {
