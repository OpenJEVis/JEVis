...
//                    DateTime firstDate = cleanDataObject.getFirstDate();
    ...
    private List<Interval> getIntervalsFromConversionToDifferentialList
            (List<DifferentialRule> listConversionToDifferential) {
        ...
        try {
            ...
            Boolean lastConversionToDifferential = listConversionToDifferential.get(size - 1).isDifferential();
            DateTime lastTimeStampOfConversion = listConversionToDifferential.get(size - 1).getStartOfPeriod();
