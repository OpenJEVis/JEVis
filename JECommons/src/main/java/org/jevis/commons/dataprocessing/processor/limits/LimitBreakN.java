 ...
 */
public class LimitBreakN {

    private final List<CleanIntervalN> intervals = new ArrayList<>();
    ...
    public LimitBreakN(Double min, Double max) {
        this.min = min;
        this.max = max;
    }

    public void addInterval(CleanIntervalN currentInterval) {
