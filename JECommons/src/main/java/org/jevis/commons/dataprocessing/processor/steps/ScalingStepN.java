 ...
 * @author broder
 */
public class ScalingStepN implements ProcessStepN {

    private static final Logger logger = LogManager.getLogger(ScalingStepN.class);
    ...
    public void run(ResourceManagerN resourceManager) throws Exception {
        ...
        for (JEVisSample multiplier : listMultipliers) {
            ...
            for (CleanIntervalN currentInt : intervals) {
