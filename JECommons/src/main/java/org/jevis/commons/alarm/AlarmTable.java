...
public class AlarmTable {
    ...
    protected final String headerCSS = "background-color: #1a719c;"
            + "color: #FFF;";
    protected final String rowCss = "text-color: #FF0000;padding: 5px;";//"border: 1px solid #D9E4E6;"
    protected final String redRowCss = "text-color: #324;padding: 5px;";//"border: 1px solid #D9E4E6;"
