...
import org.jevis.jecc.plugin.classes.ClassHelper;
import org.jevis.jecc.plugin.classes.ClassTree;
import org.jevis.jecc.plugin.classes.relationship.ValidParentEditor;
...
//                            fInherit.setText("Choose...");
                    ...
                    dia.show(ControlCenter.getStage(), I18n.getInstance().getString("dialog.error.title"),
                ...
                fIcon.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent e) {
                        ...
                        if (ControlCenter.getLastPath() != null && ControlCenter.getLastPath().isDirectory() && ControlCenter.getLastPath().canRead()) {
                            fileChooser.setInitialDirectory(ControlCenter.getLastPath().getParentFile());
                        }
                ...
                try {
                    if (ControlCenter.getDataSource().getCurrentUser().isSysAdmin()) {
...
//                boolean isInherited = !type.getJEVisClass().equals(_class);
                ...
                guiType.setDisable(!ControlCenter.getDataSource().getCurrentUser().isSysAdmin());
...
//                                }
                ...
                primType.setDisable(!ControlCenter.getDataSource().getCurrentUser().isSysAdmin());
...
//                    up.disableProperty().set(true);
                ...
                up.setGraphic(ControlCenter.getImage("1395085229_arrow_return_right_up.png", 20, 20));
...
//                    down.disableProperty().set(true);
                ...
                down.setGraphic(ControlCenter.getImage("1395085233_arrow_return_right_down.png", 20, 20));
...
//        final ChoiceBox pTypeBox = buildPrimitiveTypeBox(null);
        ...
        try {
            ...
            fName.setDisable(!ControlCenter.getDataSource().getCurrentUser().isSysAdmin());
        } catch (Exception ex) {
...
//            fIcon.setGraphic(getImageView(_class));
            ...
            ExceptionDialog dia = new ExceptionDialog();
            dia.show(ControlCenter.getStage(), I18n.getInstance().getString("plugin.classes.editor.type.alert.openfile.title"),
...
//            _class.notifyListeners(new JEVisEvent(_class, JEVisEvent.TYPE.CLASS_UPDATE));
    ...
    public void rollback() {
        try {
            ...
            ExceptionDialog dia = new ExceptionDialog();
            dia.show(ControlCenter.getStage(), "Error", "Could not  rollback changes", ex, null);
        }
    }
...
//            logger.info("getIcon for :" + jclass);
            if (jclass.getIcon() == null) {
                return ControlCenter.getImage("1393615831_unknown2.png", 30, 30);
            }
