...
public class NetGraphWidget extends Widget implements DataModelWidget {
    ...
    public void openConfig() {
        ...
        ObservableList<org.jevis.jecc.application.Chart.data.ChartData> dataTable = widgetConfigDialog.addGeneralTabsDataModelNetGraph(this.sampleHandler);
    ...
    private void updateSkin() {
        ...
        switch (netGraphPojo.getSkin()) {
            case SECTOR:
                netGraph.setRadarChartMode(RadarChartMode.SECTOR);
                break;
            case POLYGON:
                netGraph.setRadarChartMode(RadarChartMode.POLYGON);
                break;
        }
