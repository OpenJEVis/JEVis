 ...
 * @author fs
 */
public class NewNonconformitiesDialog {
    private static final Logger logger = LogManager.getLogger(NewNonconformitiesDialog.class);
        ...
        dialog.showAndWait()
                .ifPresent(response -> {
                    if (response.getButtonData().getTypeCode().equals(ButtonType.FINISH.getButtonData().getTypeCode())) {
                        ...
                        NewNonconformitiesDialog.this.response = Response.YES;
                    } else {
                        NewNonconformitiesDialog.this.response = Response.CANCEL;
                    }
                });
