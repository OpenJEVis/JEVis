...
public class EquipmentPlugin extends TablePlugin {
    ...
    private final Image taskImage = ControlCenter.getImage("building_equipment.png");
    ...
    public void handleRequest(int cmdType) {
        switch (cmdType) {
            ...
            case Constants.Plugin.Command.RELOAD:
                ...
                ControlCenter.getStatusBar().addTask(PLUGIN_NAME, clearCacheTask, ControlCenter.getImage("building_equipment.png"), true);
...
//                            });
                ...
                ControlCenter.getStatusBar().addTask(EquipmentPlugin.class.getName(), task, taskImage, true);
            });
        } else {
            Thread.sleep(500);
    ...
    private void updateList() {
        ...
        ControlCenter.getStatusBar().addTask(EquipmentPlugin.class.getName() + "Load", load, taskImage, true);
        ...
        ControlCenter.getStatusBar().addTask(EquipmentPlugin.class.getName(), loadTabs, taskImage, true);
    }
    ...
    public Region getIcon() {
        return ControlCenter.getSVGImage(Icon.BUILDING, Plugin.IconSize, Plugin.IconSize, Icon.CSS_PLUGIN);
    }
    ...
    public void setHasFocus() {
        ...
        ControlCenter.getStatusBar().addTask(PLUGIN_NAME, loadTask, ControlCenter.getImage("building_equipment.png"), true);
