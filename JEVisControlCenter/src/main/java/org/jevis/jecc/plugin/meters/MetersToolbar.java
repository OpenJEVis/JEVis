...
public class MetersToolbar extends ToolBar {
    ...
    private final ToggleButton deleteItem = new ToggleButton("", ControlCenter.getSVGImage(Icon.DELETE, iconSize, iconSize));
    private final ToggleButton exportxlsx = new ToggleButton("", ControlCenter.getSVGImage(Icon.EXCEL, this.iconSize, this.iconSize));
    private final ToggleButton rename = new ToggleButton("", ControlCenter.getSVGImage(Icon.TRANSLATE, this.iconSize, this.iconSize));

    private final ToggleButton add = new ToggleButton("", ControlCenter.getSVGImage(Icon.PLUS_CIRCLE, iconSize, iconSize));
    private final ToggleButton switchButton = new ToggleButton("", ControlCenter.getSVGImage(Icon.SWITCH, iconSize, iconSize));
    private final ToggleButton increasePrecision = new ToggleButton("", ControlCenter.getSVGImage(Icon.DECIMAL_INCREASE, iconSize, iconSize));
    private final ToggleButton decreasePrecision = new ToggleButton("", ControlCenter.getSVGImage(Icon.DECIMAL_DECREASE, iconSize, iconSize));
