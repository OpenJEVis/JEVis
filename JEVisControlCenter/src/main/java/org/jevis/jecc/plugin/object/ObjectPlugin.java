...
//        viewPane.setStyle("-fx-background-color: " + Constants.Color.LIGHT_GREY2);
    ...
    public Node getToolbar() {
        ...
        if (!initToolbar) {
            ...
            double iconSize = 20;
            ToggleButton newB = new ToggleButton("", ControlCenter.getSVGImage(Icon.PLUS_CIRCLE, iconSize, iconSize));
            ...
            ToggleButton save = new ToggleButton("", ControlCenter.getSVGImage(Icon.SAVE, iconSize, iconSize));
            GlobalToolBar.changeBackgroundOnHoverUsingBinding(save);
            GlobalToolBar.BuildEventhandler(ObjectPlugin.this, save, Constants.Plugin.Command.SAVE);

            ToggleButton delete = new ToggleButton("", ControlCenter.getSVGImage(Icon.MINUS_CIRCLE, iconSize, iconSize));
            ...
            ToggleButton addTable = new ToggleButton("", ControlCenter.getSVGImage(Icon.TABLE_PLUS, iconSize, iconSize));
            ...
            ToggleButton editTable = new ToggleButton("", ControlCenter.getImage("edit_table.png", iconSize, iconSize));
            ...
            ToggleButton createWizard = new ToggleButton("", ControlCenter.getSVGImage(Icon.WIZARD_WAND, iconSize, iconSize));
            ...
            ToggleButton collapseTree = new ToggleButton("", ControlCenter.getSVGImage(Icon.TREE, iconSize, iconSize));
            ...
            ToggleButton copyItem = new ToggleButton("", ControlCenter.getSVGImage(Icon.COPY, iconSize, iconSize));
            GlobalToolBar.changeBackgroundOnHoverUsingBinding(copyItem);
            copyItem.setOnAction(event -> {
                tree.setCopyObjectsBySelection(false);
            });

            ToggleButton pasteItem = new ToggleButton("", ControlCenter.getSVGImage(Icon.PASTE, iconSize, iconSize));
            ...
            ToggleButton cutItem = new ToggleButton("", ControlCenter.getSVGImage(Icon.CUT, iconSize, iconSize));
            GlobalToolBar.changeBackgroundOnHoverUsingBinding(cutItem);
            cutItem.setOnAction(event -> {
                tree.setCopyObjectsBySelection(true);
            });

            ToggleButton copyAttributeItem = new ToggleButton("", ControlCenter.getSVGImage(Icon.COPY_PROPERTIES, iconSize, iconSize));
            ...
            ToggleButton pasteAttributeItem = new ToggleButton("", ControlCenter.getSVGImage(Icon.PASTE_PROPERTIES, iconSize, iconSize));
            ...
            ToggleButton wizardItem = new ToggleButton("", ControlCenter.getSVGImage(Icon.WIZARD_HAT, iconSize, iconSize));
            ...
            ToggleButton reCalcItem = new ToggleButton("", ControlCenter.getSVGImage(Icon.CALCULATOR, iconSize, iconSize));
            ...
            ToggleButton exportItem = new ToggleButton("", ControlCenter.getSVGImage(Icon.EXPORT, iconSize, iconSize));
            GlobalToolBar.changeBackgroundOnHoverUsingBinding(exportItem);
            exportItem.setOnAction(event -> {
                JEVisTreeContextMenu.exportAction(tree);
            });

            ToggleButton importItem = new ToggleButton("", ControlCenter.getSVGImage(Icon.IMPORT, iconSize, iconSize));
            ...
            ToggleButton toSourceItem = new ToggleButton("", ControlCenter.getSVGImage(Icon.GO_TO_SOURCE, iconSize, iconSize));
            ...
            ToggleButton manualSampleItem = new ToggleButton("", ControlCenter.getSVGImage(Icon.MANUAL_DATA_ENTRY, iconSize, iconSize));
            ...
            ToggleButton expandTree = new ToggleButton("", ControlCenter.getImage("create_wizard.png", iconSize, iconSize));
...
//                    tree.fireEventCreateWizard(tree.getSelectedObject());
            ...
            ControlCenter.showError("Unexpected Error", ex);
...
//        }
    ...
    public Region getIcon() {
        return ControlCenter.getSVGImage(Icon.CONFIG, Plugin.IconSize, Plugin.IconSize, Icon.CSS_PLUGIN);
    }
    ...
    public void fireEventEditTable(final JEVisObject parent) throws JEVisException {
        ...
        if (parent != null) {
            if (table.show(ControlCenter.getStage(), null, parent, false, EditTable.Type.EDIT, null) == EditTable.Response.YES) {
...
//        }
    ...
    public void fireEventCreateTable(final JEVisObject parent) {
        ...
        if (parent != null) {
            if (table.show(ControlCenter.getStage(), null, parent, false, CreateTable.Type.NEW, null) == CreateTable.Response.YES) {
