...
public class BaseDataPlugin extends TablePlugin {
    ...
    public void handleRequest(int cmdType) {
        switch (cmdType) {
            ...
            case Constants.Plugin.Command.RELOAD:
                ...
                ControlCenter.getStatusBar().addTask(PLUGIN_NAME, clearCacheTask, ControlCenter.getImage("base_data.png"), true);
    ...
    private void updateList() {
        ...
        ControlCenter.getStatusBar().addTask(BaseDataPlugin.class.getName() + "Load", load, taskImage, true);
        ...
        if (!isMultiSite()) {
            ...
            ControlCenter.getStatusBar().addTask(BaseDataPlugin.class.getName(), loadTabs, taskImage, true);
        } else {
    ...
    public Region getIcon() {
        return ControlCenter.getSVGImage(Icon.DATABASE, Plugin.IconSize, Plugin.IconSize, Icon.CSS_PLUGIN);
    }
    ...
    public void setHasFocus() {
        ...
        ControlCenter.getStatusBar().addTask(PLUGIN_NAME, loadTask, ControlCenter.getImage("base_data.png"), true);
