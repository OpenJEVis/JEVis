...
import org.jevis.jecc.plugin.scada.data.ConfigSheet;
...
//        }
     ...
     * Background image
     */
    public final ObjectProperty<Image> imageBoardBackground = new SimpleObjectProperty<>(Image.class, "Dash Board Color", ControlCenter.getImage("transPixel.png"));
    /**
