...
import org.jevis.jecc.application.unit.UnitObject;
import org.jevis.jecc.application.unit.UnitTree;
...
//            GlobalToolBar.BuildEventhandler(UnitPlugin.this, delete, Constants.Plugin.Command.DELETE);
            ...
            ToggleButton reload = new ToggleButton("", ControlCenter.getImage("1403018303_Refresh.png", iconSize, iconSize));
            GlobalToolBar.changeBackgroundOnHoverUsingBinding(reload);
//            GlobalToolBar.BuildEventhandler(UnitPlugin.this, reload, Constants.Plugin.Command.RELOAD);

            ToggleButton addTable = new ToggleButton("", ControlCenter.getImage("add_table.png", iconSize, iconSize));
            ...
            ToggleButton createWizard = new ToggleButton("", ControlCenter.getImage("create_wizard.png", iconSize, iconSize));
...
//        }
    ...
    public Region getIcon() {
        return ControlCenter.getSVGImage(Icon.UNIT, Plugin.IconSize, Plugin.IconSize, Icon.CSS_PLUGIN);
    }
