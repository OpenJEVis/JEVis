...
public class LegalCatasdreToolbar extends ToolBar {
    ...
    private final ToggleButton legalPlanConfig = new ToggleButton("", ControlCenter.getSVGImage(Icon.SETTINGS, iconSize, iconSize));
    private final ToggleButton openForm = new ToggleButton("", ControlCenter.getSVGImage(Icon.PREVIEW, iconSize, iconSize));
    private final ToggleButton newLegal = new ToggleButton("", ControlCenter.getSVGImage(Icon.PLAYLIST_ADD, iconSize, iconSize));
    private final ToggleButton newLegalPlan = new ToggleButton("", ControlCenter.getSVGImage(Icon.FOLDER_OPEN, iconSize, iconSize));
    private final ToggleButton deleteLegal = new ToggleButton("", ControlCenter.getSVGImage(Icon.PLAYLIST_REMOVE, iconSize, iconSize));
    ...
    private final LegalCadastreController legalCadastreController;
