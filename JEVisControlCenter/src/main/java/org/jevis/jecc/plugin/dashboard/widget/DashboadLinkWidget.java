...
import org.jevis.jecc.plugin.dashboard.config2.DashboardLinkerNode;
...
//    private GraphAnalysisLinkerNode dataModelNode;
    MFXButton linkButton = new MFXButton("", ControlCenter.getImage("if_dashboard_46791.png", 20, 20));
...
//            linkedDashboardObj = getDataSource().getObject(3799l);
    ...
    public ImageView getImagePreview() {
        return ControlCenter.getImage("widget/LinkWidget2.png", this.previewSize.getHeight(), this.previewSize.getWidth());
    }
