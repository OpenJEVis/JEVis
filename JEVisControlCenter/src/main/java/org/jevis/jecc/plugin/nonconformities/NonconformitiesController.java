package org.jevis.jecc.plugin.nonconformities;
...
import org.jevis.jecc.plugin.nonconformities.ui.*;
...
public class NonconformitiesController {
    ...
    public void createNewNonconformityPlan() {
        ...
        try {
            NewNonconformitiesDialog.Response response = newNonconformitiesDialog.show(ControlCenter.getStage(), plugin.getDataSource());
