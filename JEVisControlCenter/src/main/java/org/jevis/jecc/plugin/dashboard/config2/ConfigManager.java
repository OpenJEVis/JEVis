...
import org.jevis.jecc.plugin.dashboard.common.WidgetIDs;
...
import static org.jevis.jecc.plugin.dashboard.config2.JsonNames.Dashboard.*;
...
//                newWidget.updateConfig();
    ...
    public ObjectProperty<Image> getBackgroundImage(JEVisObject analysisObject) {
        ObjectProperty<Image> imageBoardBackground = new SimpleObjectProperty<>(Image.class, "Dash Board Color", ControlCenter.getImage("transPixel.png"));
