...
import org.jevis.jecc.plugin.dashboard.common.DashboardExport;
...
public class DashboardControl {
    ...
    private final Image widgetTaskIcon = ControlCenter.getImage("if_dashboard_46791.png");
    ...
    public void updateWidget(Widget widget) {
        ...
        ControlCenter.getStatusBar().addTask(DashBordPlugIn.class.getName(), task, widgetTaskIcon, true);
    }
        ...
        return new Task<Object>() {
            ...
            protected Object call() throws Exception {
                try {
                    ...
                    this.done();
                    ControlCenter.getStatusBar().progressProgressJob("Dashboard", 1
...
//                jeVisSample.commit();
    ...
    public void toPDF() {
        ...
        ScreenSize.fixScreenshotLayout(ControlCenter.getStage());
