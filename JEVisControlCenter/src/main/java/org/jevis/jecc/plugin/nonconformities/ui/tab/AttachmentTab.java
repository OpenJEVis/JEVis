...
import org.jevis.jecc.plugin.nonconformities.data.FileData;
import org.jevis.jecc.plugin.nonconformities.data.NonconformityData;
import org.jevis.jecc.plugin.nonconformities.ui.FileTableView;
...
public class AttachmentTab extends Tab {
    ...
    public void initTab(NonconformityData data) {
        ...
        double iconSize = 12;
        Button addFileButton = new Button("", ControlCenter.getSVGImage(Icon.PLUS, iconSize, iconSize));
        Button downloadFileButton = new Button("", ControlCenter.getSVGImage(Icon.EXPORT, iconSize, iconSize));
        Button deleteFileButton = new Button("", ControlCenter.getSVGImage(Icon.DELETE, iconSize, iconSize));
        ...
        addFileButton.setOnAction(event -> {
            try {
                ...
                File file = fileChooser.showOpenDialog(ControlCenter.getStage());
                if (file != null) {
