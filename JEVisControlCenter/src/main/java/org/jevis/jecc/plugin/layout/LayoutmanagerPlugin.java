package org.jevis.jecc.plugin.layout;
...
public class LayoutmanagerPlugin implements Plugin {
    ...
    public Node getToolbar() {
        ...
        if (toolBar == null) {
            ...
            ToggleButton newB = new ToggleButton("", ControlCenter.getImage("iconfinder_ic_play_circle_outline_48px_352074.png", iconSize, iconSize));
