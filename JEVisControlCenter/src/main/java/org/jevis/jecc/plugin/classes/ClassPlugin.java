...
//                    .build();
    ...
    public Node getToolbar() {
        if (toolBar == null) {
            ...
            ToggleButton delete = new ToggleButton("", ControlCenter.getSVGImage(Icon.DELETE, iconSize, iconSize));
            ...
            ToggleButton editTable = new ToggleButton("", ControlCenter.getSVGImage(Icon.EDIT, iconSize, iconSize));
            ...
            try {
                toolBar.setDisable(!ControlCenter.getDataSource().getCurrentUser().isSysAdmin());
            } catch (Exception ex) {
                logger.error(ex);
            }
    ...
    public Region getIcon() {
        return ControlCenter.getSVGImage(Icon.CLASS, Plugin.IconSize, Plugin.IconSize, Icon.CSS_PLUGIN);
    }
