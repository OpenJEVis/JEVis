package org.jevis.jecc.plugin.object.extension.paramter;
...
public class ParameterGui {
    ...
    private final Type parameterListType = new TypeToken<List<Parameter>>() {
    }.getType();
    ...
    public boolean save(JEVisAttribute pathAttribute, JEVisAttribute parameterAttribute) {
        return saveParameter(parameterAttribute) && savePath(pathAttribute);
    }
