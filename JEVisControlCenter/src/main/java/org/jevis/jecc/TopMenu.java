...
import org.jevis.jecc.application.Chart.data.FavoriteAnalysis;
import org.jevis.jecc.application.Chart.data.FavoriteAnalysisHandler;
import org.jevis.jecc.application.tools.JEVisHelp;
import org.jevis.jecc.csv.CSVImportDialog;
import org.jevis.jecc.dialog.AboutDialog;
...
public class TopMenu extends MenuBar {
        ...
        if (getActivePlugin() != null && getActivePlugin() instanceof ChartPlugin chartPlugin) {
            ...
            addAnalysisToFavorites.setOnAction(event -> {
                ...
                if (selectedAnalysis != null) {
                    ...
                    confirmationDialog.initOwner(ControlCenter.getStage());
            ...
            for (FavoriteAnalysis favoriteAnalysis : favoriteAnalysisHandler.getFavoriteAnalysesList()) {
                try {
                    JEVisObject analysisObject = ControlCenter.getDataSource().getObject(favoriteAnalysis.getId());

                    DataSettings dataSettings = new DataSettings();

                    AnalysisTimeFrame analysisTimeFrame = new AnalysisTimeFrame(ControlCenter.getDataSource(), analysisObject, favoriteAnalysis.getTimeFrame());
    ...
    private Menu createSystemMenu() {
        ...
        driverImport.setOnAction(event -> {
            ...
            if (selectedFile != null) {
                ...
                ClassImporter ci = new ClassImporter(ControlCenter.getDataSource());
        ...
        try {
            driverImport.setDisable(!ControlCenter.getDataSource().getCurrentUser().isSysAdmin());
        } catch (Exception ex) {
            logger.fatal(ex);
    ...
    private Menu createHelpMenu() {
        ...
        about.setOnAction(t -> {
            ...
            dia.show(I18n.getInstance().getString("menu.about.title")
                    ...
                    , ControlCenter.PROGRAM_INFO, ControlCenter.getImage("JEConfig_mac.png"));
        ...
        showChangelog.setOnAction(event -> {
            ...
            patchNotesPage.show(ControlCenter.getStage());
        });
        return help;
    }
    ...
    private Menu createViewMenu() {
        ...
        CheckMenuItem primerLightTheme = new CheckMenuItem(I18n.getInstance().getString("menu.view.theme.norddark"));
    ...
    private Menu createOptionsMenu() {
        ...
        changePassword.setOnAction(event -> {
            ...
            try {
                if (dia.show(ControlCenter.getStage(), ControlCenter.getDataSource().getCurrentUser().getUserObject()) == PasswordDialog.Response.YES) {
        ...
        expertMode.setOnAction(e -> {
            ...
            pinDialog.initOwner(ControlCenter.getStage());
