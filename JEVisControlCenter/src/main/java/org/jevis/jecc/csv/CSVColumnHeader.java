...
import org.jevis.jecc.application.unit.UnitChooserDialog;
            ...
            public void handle(ActionEvent t) {
                ...
                try {
                    if (_target != null) {
                        ...
                        dia.show(ControlCenter.getStage(), _target);
...
//        timeZone.getSelectionModel().select("UTC");
        ...
        ImageView help = ControlCenter.getImage("1404161580_help_blue.png", 22, 22);
