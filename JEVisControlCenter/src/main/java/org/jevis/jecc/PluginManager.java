...
import org.jevis.jecc.map.MapViewPlugin;
import org.jevis.jecc.plugin.accounting.AccountingPlugin;
import org.jevis.jecc.plugin.action.ActionPlugin;
import org.jevis.jecc.plugin.alarms.AlarmPlugin;
import org.jevis.jecc.plugin.basedata.BaseDataPlugin;
import org.jevis.jecc.plugin.browser.ISO50001Plugin;
...
import org.jevis.jecc.plugin.reports.ReportPlugin;
import org.jevis.jecc.tool.DraggableTab;
...
//        plugins.add(new SCADAPlugin(_ds));
        ...
        plugins.add(new org.jevis.jecc.plugin.classes.ClassPlugin(this._ds, I18n.getInstance().getString("plugin.classes.title")));
        plugins.add(new org.jevis.jecc.plugin.unit.UnitPlugin(this._ds, I18n.getInstance().getString("plugin.units.title")));
