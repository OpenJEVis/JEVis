...
public class PatchNotesPage {
    ...
    public void show(Stage owner) {
        ...
        if (!pref.getBoolean("show", true)) {
            if (pref.get("version", "").equals(ControlCenter.class.getPackage().getImplementationVersion())) {
                return;
            }
        }
...
//        BorderPane root = new BorderPane();
    ...
    private void storePreference() {
        ...
        try {
            pref.put("version", ControlCenter.class.getPackage().getImplementationVersion());
