...
import org.jevis.jecc.application.control.rtf.*;
...
//        ControlCenter.getStage().getScene().getStylesheets().add(RtfField.class.getResource("/rtf/richtext/rich-text.css").toExternalForm());
