...
//        });
        ...
        setConverter(new StringConverter<AnalysisTimeFrame>() {
            ...
            public String toString(AnalysisTimeFrame object) {
                String text = "";
                if (object != null) {
                    text = object.getTimeFrame().getLocalName();
                }
                return text;
            }
            ...
            public AnalysisTimeFrame fromString(String string) {
                return getItems().stream().filter(analysisTimeFrame -> analysisTimeFrame.getTimeFrame().getLocalName().equals(string)).findFirst().orElse(null);
            }
        });
