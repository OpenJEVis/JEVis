...
public class MultiChartZoomer extends de.gsi.chart.plugins.ChartPlugin {
    ...
    private List<org.jevis.jecc.application.Chart.Charts.Chart> notActive;
    private org.jevis.jecc.application.Chart.Charts.Chart currentChart;
     ...
     * @param zoomMode initial value of {@link #axisModeProperty() zoomMode} property
     */
    public MultiChartZoomer(final ChartPlugin chartPlugin, final AxisMode zoomMode, List<org.jevis.jecc.application.Chart.Charts.Chart> notActive, org.jevis.jecc.application.Chart.Charts.Chart currentChart) {
     ...
     */
    public MultiChartZoomer(final ChartPlugin chartPlugin, final AxisMode zoomMode, List<org.jevis.jecc.application.Chart.Charts.Chart> notActive, org.jevis.jecc.application.Chart.Charts.Chart currentChart, final boolean animated) {
        super();
        ...
        if (!followUpZoom) {
            notActive.forEach(chart -> {
                if (chart instanceof org.jevis.jecc.application.Chart.Charts.XYChart) {
                    ...
                    double min = ((org.jevis.jecc.application.Chart.Charts.XYChart) currentChart).getPrimaryDateAxis().getMin();
                    double max = ((org.jevis.jecc.application.Chart.Charts.XYChart) currentChart).getPrimaryDateAxis().getMax();
...
//        if (isZoomIn && ((axis.getSide().isHorizontal() && getAxisMode().allowsX()) || (axis.getSide().isVertical() && getAxisMode().allowsY()))) {
        ...
        if (currentChart != null) {
            valueForDisplayLeft = ((org.jevis.jecc.application.Chart.Charts.XYChart) currentChart).getPrimaryDateAxis().getValueForDisplay(zoomRectangle.getX());
            double x2 = zoomRectangle.getX() + zoomRectangle.getWidth();
            valueForDisplayRight = ((org.jevis.jecc.application.Chart.Charts.XYChart) currentChart).getPrimaryDateAxis().getValueForDisplay(x2);
...
//        registerInputEventHandler(ScrollEvent.SCROLL, zoomScrollHandler);
    ...
    private void zoomInEnded() {
        ...
        org.jevis.jecc.application.Chart.Charts.XYChart xyChart = (org.jevis.jecc.application.Chart.Charts.XYChart) currentChart;
        ...
        if (zoomRectangle.getHeight() != 0 && zoomRectangle.getWidth() != 0) {
            ...
            if (!followUpZoom) {
                notActive.forEach(chart -> {
                    if (chart instanceof org.jevis.jecc.application.Chart.Charts.XYChart) {
                        double displayPositionLeftX = ((org.jevis.jecc.application.Chart.Charts.XYChart) chart).getPrimaryDateAxis().getDisplayPosition(valueForDisplayLeft);
                        double displayPositionRightX = ((org.jevis.jecc.application.Chart.Charts.XYChart) chart).getPrimaryDateAxis().getDisplayPosition(valueForDisplayRight);
    ...
    public List<org.jevis.jecc.application.Chart.Charts.Chart> getNotActive() {
        return notActive;
    }

    public void setNotActive(List<org.jevis.jecc.application.Chart.Charts.Chart> notActive) {
        this.notActive = notActive;
    }

    public org.jevis.jecc.application.Chart.Charts.Chart getCurrentChart() {
        return currentChart;
    }

    public void setCurrentChart(org.jevis.jecc.application.Chart.Charts.Chart currentChart) {
