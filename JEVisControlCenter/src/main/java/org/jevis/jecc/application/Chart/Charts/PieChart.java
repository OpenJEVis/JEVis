...
public class PieChart implements Chart {
    ...
    public PieChart(JEVisDataSource ds, ChartModel chartModel) {
        ...
        ControlCenter.getStatusBar().startProgressJob(XYChart.JOB_NAME, totalJob, I18n.getInstance().getString("plugin.graph.message.startupdate"));
...
//            String seriesName = name + " - " + nf.format(listSumsPiePieces.get(listTableEntryNames.indexOf(name)))
            ...
            ControlCenter.getStatusBar().progressProgressJob(XYChart.JOB_NAME, 1, I18n.getInstance().getString("graph.progress.finishedserie") + " " + name);
        }
