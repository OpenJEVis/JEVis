 ...
 * <p>
 * ControlCenter is free software: you can redistribute it and/or modify it under the
 * terms of the GNU General Public License as published by the Free Software
 * Foundation in version 3.
 * <p>
 * ControlCenter is distributed in the hope that it will be useful, but WITHOUT ANY
 * WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR
 * A PARTICULAR PURPOSE. See the GNU General Public License for more details.
 * <p>
 * You should have received a copy of the GNU General Public License along with
 * ControlCenter. If not, see <http://www.gnu.org/licenses/>.
 * <p>
 * ControlCenter is part of the OpenJEVis project, further project information are
...
import org.jevis.jecc.application.tools.ImageConverter;
import org.jevis.jecc.dialog.*;
import org.jevis.jecc.export.TreeExporter;
import org.jevis.jecc.plugin.object.extension.OPC.OPCBrowser;
import org.jevis.jecc.plugin.object.extension.revpi.RevPiAssistant;
import org.jevis.jecc.tool.AttributeCopy;
...
public class JEVisTreeContextMenu extends ContextMenu {
    ...
    public static void exportAction(JEVisTree tree) {
        ...
        if (file != null) {
            ...
            ControlCenter.getStatusBar().addTask("Tree Exporter", exportTask, ControlCenter.getImage("save.gif"), true);
    ...
    public static void importAction(JEVisObject obj) {
        ...
        if (selectedFile != null) {
            try {
                ...
                ControlCenter.getStatusBar().addTask("Tree Importer", exportTask, ControlCenter.getImage("save.gif"), true);
    ...
    private MenuItem buildGoToSource() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.gotosrc"), ControlCenter.getSVGImage(Icon.GO_TO_SOURCE, 20, 20));
        menu.setOnAction(t -> {
                    goToSource(tree, obj);
                }
        ...
        tree.setOnMouseClicked(event -> {
            try {
                ...
                if (obj.getDeleteTS() != null) {
                    ...
                    } else if (ControlCenter.getExpert() && obj.getJEVisClassName().equals("Data Directory")) {
    ...
    private MenuItem buildJsonHTTP() {
        MenuItem menu = new MenuItem("JSON Wizard", ControlCenter.getSVGImage(Icon.WIZARD_HAT, 20, 20));
        ...
        menu.setOnAction(actionEvent -> {
            ...
            buttonTypeDialog.initOwner(ControlCenter.getStage());
    ...
    private MenuItem buildReCalcClean() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.recalculate"), ControlCenter.getSVGImage(Icon.CALCULATOR, 20, 20));
    ...
    private MenuItem buildCreateAlarms() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.createalarms"), ControlCenter.getSVGImage(Icon.ALARM, 20, 20));
    ...
    private MenuItem buildOCP() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.opc"), ControlCenter.getSVGImage(Icon.WIZARD_HAT, 20, 20));
    ...
    private MenuItem buildRevPi() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.revpi.assistant"), ControlCenter.getSVGImage(Icon.WIZARD_HAT, 20, 20));
    ...
    private MenuItem buildPaste() {
        ...
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.paste"), ControlCenter.getSVGImage(Icon.PASTE, 20, 20));
    ...
    private MenuItem buildCopy() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.copy"), ControlCenter.getSVGImage(Icon.PASTE, 20, 20));
    ...
    private MenuItem buildCut() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.cut"), ControlCenter.getSVGImage(Icon.CUT, 20, 20));
    ...
    private MenuItem buildKPIWizard() {
        MenuItem menu = new MenuItem("KPI Wizard", ControlCenter.getSVGImage(Icon.WIZARD_WAND, 20, 20));
        menu.setOnAction(t -> {
    ...
    private MenuItem buildExport() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.export"), ControlCenter.getSVGImage(Icon.EXPORT, 20, 20));
        menu.setOnAction(t -> {
                    exportAction(tree);
                }
        );
    ...
    private MenuItem buildImport() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.import"), ControlCenter.getSVGImage(Icon.IMPORT, 20, 20));
    ...
    public MenuItem buildMenuAddInput() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.addinput"), ControlCenter.getSVGImage(Icon.EXPORT, 20, 20));
    ...
    public MenuItem buildMenuLocalize() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.localename"), ControlCenter.getSVGImage(Icon.TRANSLATE, 20, 20));
        menu.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                try {
    ...
    public MenuItem buildManualSample() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("menu.file.import.manual"), ControlCenter.getSVGImage(Icon.MANUAL_DATA_ENTRY, 20, 20));
        menu.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                try {
    ...
    private Menu buildMenuNew() {
        Menu addMenu = new Menu(I18n.getInstance().getString("jevistree.menu.new"), ControlCenter.getSVGImage(Icon.TABLE_PLUS, 20, 20));
...
//                _item.expandAll(true);
    ...
    private MenuItem buildNew2() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.new"), ControlCenter.getSVGImage(Icon.PLUS_CIRCLE, 20, 20));
        menu.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent t) {
    ...
    private MenuItem buildReload() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.reload"), ControlCenter.getSVGImage(Icon.REFRESH, 20, 20));
        menu.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent t) {
    ...
    private MenuItem buildDelete(boolean deleteForever) {
        MenuItem menu;
        if (deleteForever) {
            menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.deleteforever"), ControlCenter.getSVGImage(Icon.MINUS_CIRCLE, 20, 20));
        } else {
            menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.delete"), ControlCenter.getSVGImage(Icon.MINUS_CIRCLE, 20, 20));
        }
        menu.setOnAction(new EventHandler<ActionEvent>() {
    ...
    private MenuItem buildReportWizard() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("plugin.object.report.dialog.wizard"), ControlCenter.getSVGImage(Icon.WIZARD_HAT, 20, 20));
        menu.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent t) {
    ...
    private MenuItem buildCopyFormat() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("jevistree.menu.copyformat"), ControlCenter.getSVGImage(Icon.COPY_PROPERTIES, 20, 20));
        menu.setOnAction(new EventHandler<ActionEvent>() {
    ...
    private MenuItem buildParsedFormat() {
        MenuItem menu = new MenuItem(I18n.getInstance().getString("dialog.attributecopy.paste"), ControlCenter.getSVGImage(Icon.PASTE_PROPERTIES, 20, 20));
        menu.setOnAction(new EventHandler<ActionEvent>() {
