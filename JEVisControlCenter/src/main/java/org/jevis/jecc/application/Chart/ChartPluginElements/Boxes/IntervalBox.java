...
//        timePicker.setConverter(new LocalTimeStringConverter(FormatStyle.SHORT));
        ...
        if (date != null) {
            ...
            timePicker.setLocalTime(LocalTime.of(selectedStart.getHourOfDay(), selectedStart.getMinuteOfHour(), selectedStart.getSecondOfMinute()));
        }
    ...
    public String getDate() {
        return new DateTime(datePicker.getValue().getYear(), datePicker.getValue().getMonthValue(), datePicker.getValue().getDayOfMonth(),
                timePicker.getLocalTime().getHour(), timePicker.getLocalTime().getMinute(), timePicker.getLocalTime().getSecond()).toString();
    }
    ...
    public void setDate(String dateString) {
        ...
        timePicker.setLocalTime(LocalTime.of(dateTime.getHourOfDay(), dateTime.getMinuteOfHour(), dateTime.getSecondOfMinute()));
    }
