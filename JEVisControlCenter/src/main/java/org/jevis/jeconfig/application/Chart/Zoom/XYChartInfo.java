...
public class XYChartInfo {
    private final MultiAxisChart<?, ?> chart;
     ...
     * system.
     */
    public XYChartInfo(MultiAxisChart<?, ?> chart, Node referenceNode) {
        this.chart = chart;
     ...
     */
    public XYChartInfo(MultiAxisChart<?, ?> chart) {
        this(chart, chart);
    }

    public MultiAxisChart<?, ?> getChart() {
        return chart;
    }
    ...
    public Point2D getDataCoordinatesY1(double x, double y) {
        Axis xAxis = chart.getXAxis();
        Axis yAxis = chart.getY1Axis();
     ...
     */
    @SuppressWarnings("unchecked")
    public Point2D getDataCoordinatesY2(double x, double y) {
        Axis xAxis = chart.getXAxis();
        Axis yAxis = chart.getY2Axis();
     ...
     */
    @SuppressWarnings("unchecked")
    public Rectangle2D getDataCoordinatesY1(double minX, double minY, double maxX, double maxY) {
     ...
     */
    @SuppressWarnings("unchecked")
    public Rectangle2D getDataCoordinatesY2(double minX, double minY, double maxX, double maxY) {
        if (minX > maxX || minY > maxY) {
            throw new IllegalArgumentException("min > max for X and/or Y");
        }
...
//		double height = yAxis.getDisplayPosition( yAxis.toRealValue( yAxis.getLowerBound() ) );
     ...
     */
    public Rectangle2D getY1AxisArea() {
        return getComponentArea(chart.getY1Axis());
    }

    public Rectangle2D getY2AxisArea() {
        return getComponentArea(chart.getY2Axis());
    }
