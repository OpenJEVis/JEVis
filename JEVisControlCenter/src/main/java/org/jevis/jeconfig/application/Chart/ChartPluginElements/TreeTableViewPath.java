...
public class TreeTableViewPath extends ScrollPane {
    ...
    private final StyleableDoubleProperty offset = new SimpleStyleableDoubleProperty(
            TreeTableViewPath.StyleableProperties.OFFSET,
            TreeTableViewPath.this,
            "offset",
            10.0);
    private double lastX;

    public TreeTableViewPath(TreeTableView<?> treeView) {
    ...
    public static List<CssMetaData<? extends Styleable, ?>> getClassCssMetaData() {
        return TreeTableViewPath.StyleableProperties.CHILD_STYLEABLES;
    }
    ...
    private static class StyleableProperties {
        private static final CssMetaData<TreeTableViewPath, Number> OFFSET =
                new CssMetaData<TreeTableViewPath, Number>("-jfx-offset",
                        SizeConverter.getInstance(), 10.0) {
                    @Override
                    public boolean isSettable(TreeTableViewPath control) {
                        return control.offset == null || !control.offset.isBound();
                    }

                    @Override
                    public StyleableDoubleProperty getStyleableProperty(TreeTableViewPath control) {
