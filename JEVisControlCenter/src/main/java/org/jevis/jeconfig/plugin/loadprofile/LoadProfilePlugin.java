...
import org.jevis.jeconfig.plugin.loadprofile.data.TableSample;
...
public class LoadProfilePlugin implements Plugin {
    ...
    private void initGui() {
        ...
        Button removeInput = new Button("", JEConfig.getSVGImage(Icon.DELETE, iconSize, iconSize));
    ...
    private void calculate() {
        ...
        JEConfig.getStatusBar().addTask(this.getName(), calculate, null, true);
    }
    ...
    private TableColumn<MixedLoadProfile, Object> createWorkdayValueColumn(String columnName) {
        ...
        column.setCellFactory(org.jevis.jeconfig.plugin.loadprofile.controls.ValueFieldTableCell.forTableColumn());
