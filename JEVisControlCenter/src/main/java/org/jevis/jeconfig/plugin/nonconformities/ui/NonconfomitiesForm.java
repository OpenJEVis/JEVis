...
public class NonconfomitiesForm extends Alert {
    ...
    public NonconfomitiesForm(Nonconformities nonconformities) {
    ...
    public void updateView(Nonconformities nonconformities) {
        ...
        f_numberPrefix.textProperty().bindBidirectional(nonconformities.prefixProperty());
