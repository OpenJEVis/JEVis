...
public class ChildrenEditorExtension implements ObjectEditorExtension {
    ...
    private final ToggleButton reloadButton = new ToggleButton("", JEConfig.getImage("1403018303_Refresh.png", 20, 20));
    private final HBox dateSelection = new HBox(6, startDatePicker, endDatePicker, reloadButton);
...
//        this.viewPane.setStyle("-fx-background-color: " + Constants.Color.LIGHT_GREY2);
    ...
    public void setVisible() {
        ObjectTable objectTable = new ObjectTable(this.parentObject, startDatePicker, endDatePicker, reloadButton);
