...
public class JEDataProcessorShutdownHookThread extends Thread {
    private static final Logger logger = LogManager.getLogger(JEDataProcessorShutdownHookThread.class);
     ...
     */
    public JEDataProcessorShutdownHookThread(Thread service) {
        this.thread = service;
        setName(THREAD_NAME);
    }
