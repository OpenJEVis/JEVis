 ...
 * <code>null</code> input gracefully. An exception will not be thrown for a
 * <code>null</code> input. Each method documents its behaviour in more
 * detail.</p>
 *
...
public class LocaleUtils {
    ...
    //-----------------------------------------------------------------------
    /**
     * <p>Obtains the list of locales to search through when performing a locale
     * search.</p>
     *
     * <pre>
     ...
     * </pre>
     *
     * <p>The result list begins with the most specific locale, then the next
     * more general and so on, finishing with the default locale. The list will
     * never contain the same locale twice.</p>
     *
     ...
     * It is more efficient, as the JDK method must create a new array each time
     * it is called.</p>
     *
     ...
     *
     * <p>This method takes a country code and searches to find the languages
     * available for that country. Variant locales are removed.</p>
     *
     ...
     *
     * <p>This method takes a language code and searches to find the countries
     * available for that language. Variant locales are removed.</p>
     *
