...
public class ObjectGraphic {
    ...
    public ObjectGraphic(ObjectContainer obj, SelectionTree tree) {
        _container = obj;
        _tree = tree;
...
//        icon = getIcon(_obj);
        ...
        if (_container.isObject()) {
            ...
            nameLabel.setText(_container.getAttribute().getName());
//            _view.getChildren().setAll(icon, nameLabel, _spacer, _checkBox);
            _view.getChildren().setAll(_checkBox, icon, nameLabel, _spacer);
        }
