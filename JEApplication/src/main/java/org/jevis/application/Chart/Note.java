    ...
    public Note(String note, Color color) {
        if (note != null) {
            ...
            if (note.contains("limit(Step1)")) {
                try {
                    ImageView warning = ResourceLoader.getImage("Warning-icon.png", iconSize, iconSize);
            ...
            if (note.contains("gap(") || note.contains("limit(Default)") || note.contains("limit(Static)") || note.contains("limit(Average)")
                ...
                try {
                    ImageView limit = ResourceLoader.getImage("rodentia-icons_dialog-warning.png", iconSize, iconSize);
            ...
            if (hbox.getChildren().size() == 2) {
                ...
                try {
                    ImageView exception = ResourceLoader.getImage("rodentia-icons_process-stop.png", iconSize, iconSize);
